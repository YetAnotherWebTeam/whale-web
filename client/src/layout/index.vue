<template>
  <v-app>
    <v-app-bar dense app>
      ...
      <v-menu open-on-click left bottom offset-y>
        <template v-slot:activator="{ on, attrs }">
          ...
          <v-avatar v-bind="attrs" v-on="on">
            <img v-if="isAuthenticated" :src="gravatar" />
            <v-icon v-else> mdi-incognito </v-icon>
          </v-avatar>
        </template>
        <v-list dense nav>
